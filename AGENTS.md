...
5. Inspect existing patterns before adding new ones.
6. Create a short PRD or implementation brief and save it in the appropriate docs folder before implementation.
7. For complex work, include:
   - Problem
   - Scope
   - Out of scope
   - Acceptance criteria
